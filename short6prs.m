    ...
    function [fval,fc,fmon,fcar,fdep] = short6prs(Ad,Cs,pdis,pcha,batcap,eff,pgrid,Cb,depr,start,batmin,T,outputcarbon,Db,Ds,weight,avp,x0,A,B,Aeq,Beq,options,coop,trials,A2,A3eq,avda,avga,b1,b2,b3,b4,b5,b6)  
...
fc=x;
 [fvv,fmong,fcarg,fdepg]=traf6pr(x,Db,Ds,outputcarbon,T,Cb,depr,batcap,weight,eff,b1,b2,b3,b4,b5,b6);
    disp(fvv)
    fmon = fmong;
    fcar = fcarg;
    fdep = fdepg;
